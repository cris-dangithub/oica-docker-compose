...
COMMENT ON COLUMN processing_results.perfil_usado IS 'Perfil de optimización: rapido, balanceado, profundo';
...
CREATE INDEX IF NOT EXISTS idx_uploaded_files_document_number ON uploaded_files(document_number);
...
CREATE INDEX IF NOT EXISTS idx_processing_results_file_id ON processing_results(uploaded_file_id);
CREATE INDEX IF NOT EXISTS idx_processing_results_version ON processing_results(uploaded_file_id, version_number DESC);
CREATE INDEX IF NOT EXISTS idx_processing_results_status ON processing_results(result_status);
CREATE INDEX IF NOT EXISTS idx_processing_results_uuid ON processing_results(storage_uuid);
CREATE INDEX IF NOT EXISTS idx_processing_results_perfil ON processing_results(perfil_usado);
